...
multi <- Read10X("/group/sottoriva/00-PROCESSED_DATA/2023-ROVIGO/BTROHT04/BTROHT04_T7_T10/multiome/LAZ_158/filtered_feature_bc_matrix")
...
mybarcode_list <- read.table("/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT04/Perimarginal/CONGAS/BTROHT04_peri_barcodes_all.tsv", sep="\t", header=TRUE)
mybarcode_list
...
myfeatures <- fread("gunzip -c /group/sottoriva/00-PROCESSED_DATA/2023-ROVIGO/BTROHT04/BTROHT04_T7_T10/multiome/LAZ_158/filtered_feature_bc_matrix/features.tsv.gz")
...
```{r}
getwd()
mysegs <- read.csv("/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT04/Perimarginal/CONGAS/BTROHT04_peri_segs_for_congas.csv", sep = "\t", row.names = 1)
mysegs
...
```{r}
getwd()
saveRDS(fit_filt, "/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT04/Perimarginal/CONGAS/rcongas_obj_filtered_BTROHT04_peri_all_cells.rds")
```
...
df
getwd()
write.table(df, file = "/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT04/Perimarginal/CONGAS/ploidy_by_segments_BTROHT04_peri.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
```

```{r}
write.csv(fit_filt$best_fit$cluster_assignments, file = "/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT04/Perimarginal/CONGAS/BTROHT04_peri_CONGAS_Clusters.csv", row.names = FALSE)
```
