...
mybarcode_list <- read.table("/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT01/Core/CONGAS/BTROHT01_core_barcodes_all.tsv", sep="\t", header=TRUE)
mybarcode_list
...
saveRDS(fit_filt, "/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT01/Core/CONGAS/rcongas_obj_filtered_BTROHT01_core_all_cells.rds")
```
...
# Define the output file path
output_file <- "CONGAS_clusterb1core.pdf"
...
getwd()
# Define the output file path
output_file <- "density_fitplotb1core.pdf"
...
```{r}
# Define the output file path
output_file <- "heatmap_b1core.pdf"
...
df
getwd()
write.table(df, file = "/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT01/Core/CONGAS/ploidy_by_segments_BTROHT01_core.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
```

```{r}
write.csv(fit_filt$best_fit$cluster_assignments, file = "/home/fatemeh.nasrabadi/ROVIGO_congas/BTROHT01/Core/CONGAS/BTROHT01_CONGAS_Clusters.csv", row.names = FALSE)
```
